...
export default function SideBar() {
    return (
        <div className="z-50 fixed flex flex-row bottom-0 bg-background shadow-lg border border-white rounded-full
        md:border-none md:bg-transparent md:flex-col md:top-12 md:left-0">
