        ...
        <div className="ml-10 mr-10 mb-24 md:mb-0">
            <Grid container spacing={2}>
                <Grid item xs={12} md={8}>
                    ...
                    <div className="text-white md:mr-20 text-2xl pt-4 text-justify">A Computer Scientist who is passionate about <b>Software Engineering</b>, <b>Game Development</b>, and <b>Music</b>.</div>
